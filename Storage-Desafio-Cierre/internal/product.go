...
// ProductSaleCount is the struct that represents the sale count of a product for top N products.
type ProductSaleCount struct {
	ProductId   int    // Id of the product.
	Description string // Description of the product.
	SaleCount   int    // Quantity of sales of the product.
}
